...
- (id)initWithImageView:(UIImageView *)imageView
{
    ...
    if (self) {
        ...
        self.lineColor = [UIColor colorWithRed:1.0 green:0.0 blue:0.0 alpha:0.7];
    }
    return self;
}
...
- (UIImage *)setMaskFor:(UIImageView *)image
{
    ...
    //  This is used to crop the picture to the bounds of the path
    //
...
- (void)touchesBegan:(NSSet *)touches withEvent:(UIEvent *)event
{
    ...
    id secondViewControllerResponder = [[self nextResponder] nextResponder];
    [secondViewControllerResponder touchesBegan:touches
                                      withEvent:event];
...
{
    // pass this action to ViewController
    id secondViewControllerResponder = [[self nextResponder] nextResponder];
    [secondViewControllerResponder touchesEnded:touches
                                      withEvent:event];
}
@end
